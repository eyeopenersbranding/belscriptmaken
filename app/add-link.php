			...
			<div class="container-fluid">
				...
				<div class="col-md-8">
									 ...
									 <div class="row">
										...
										<div class="col-sm-10">
											<div class="form-group label-floating is-empty">
												...
												<input type='hidden' name='tab_id' value='661' />
					...
					<h2>Maak een keuze:</h2>
						...
						<a href='add-link.php?tab_id=<?php echo "$tab_id" ?>&box_type=button'><button type="submit"  class="btn btn-primary"> Button aanmaken</button></a>
						...
						<div class="col-lg-4">
								<div class="card card-pricing card-raised">
									<div class="content">
										...
										<a href='add-link.php?tab_id=<?php echo "$tab_id" ?>&box_type=smallbox
					   ...
					   <div class="col-lg-6">
							<div class="card card-pricing card-raised">
								<div class="content">
									...
									<a href='add-link.php?tab_id=<?php echo "$tab_id" ?>&box_type=bigbox'><button type="submit"  class="btn btn-primary">Grote box aanmaken</button></a>
								</div>
							</div>
					   </div>
